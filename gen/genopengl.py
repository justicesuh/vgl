...
v_type_map = {
    ...
    'java.nio.LongBuffer': 'voidptr',
    'java.lang.CharSequence': 'byteptr',
    'java.lang.CharSequence...': '*byteptr',
    'java.lang.CharSequence[]': '*byteptr',
...
def generate(c, data):
    ...
    with open('{}/{}.v'.format(path, c), 'w') as f:
        ...
        f.write('#flag  -I @VROOT/thirdparty/glad\n')
        f.write('#flag @VROOT/thirdparty/glad/glad.o\n')
        ...
        for method in data['methods']:
            ...
            # skip ngl_
            if v_name.startswith('ngl_'):
                continue

            # remove gl_ prefix
            if v_name.startswith('gl_'):
                v_name = v_name[3:]
